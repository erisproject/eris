...
#define _eris_tstr std::time_t _eris_debug_t = std::time(nullptr); char _eris_debug_tstr[100]; std::strftime(_eris_debug_tstr, sizeof(_eris_debug_tstr), "[%c] ", std::localtime(&_eris_debug_t))
