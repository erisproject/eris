...
if (NOT GTEST_SRC)
    ...
    if (GTEST_CMakeLists STREQUAL "GTEST_CMakeLists-NOTFOUND")
        message(STATUS "gtest NOT FOUND (if available, try specifying with -DGTEST_ROOT=/path/to/gtest/src)")
    else()
        ...
        message(STATUS "Found gtest: ${GTEST_SRC}")
    endif()
else()
    message(STATUS "Found gtest (cached): ${GTEST_SRC}")
endif()

if (GTEST_SRC)
        add_subdirectory(${GTEST_SRC} ${GTEST_LIB})
endif()
